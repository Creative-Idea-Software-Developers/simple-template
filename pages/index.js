...
const Dashboard = () => {
    ...
    const formatCurrency = (value) => {
        return value.toLocaleString('es-ES', { style: 'currency', currency: 'PEN' });
    };
        ...
        <div className="grid">
            <div className="col-12 lg:col-6 xl:col-3">
                <div className="card mb-0">
                    ...
                    <span className="text-green-500 font-medium">0 nuevos </span>
                ...
                <div className="card mb-0">
                    <div className="flex justify-content-between mb-3">
                        <div>
                            ...
                            <div className="text-900 font-medium text-xl">$00.00</div>
                        </div>
                ...
                <div className="card mb-0">
                    <div className="flex justify-content-between mb-3">
                        <div>
                            ...
                            <div className="text-900 font-medium text-xl">0 No leído</div>
                        </div>
                    ...
                    <span className="text-green-500 font-medium">0 </span>
                    <span className="text-500">respondió</span>
                </div>
            </div>
                ...
                <div className="card" >
                    ...
                    <ul className="list-none p-0 m-0">
                        <li className="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                            <div>
                                <span className="text-900 font-medium mr-2 mb-1 md:mb-0">CPU Gamer</span>
                                <div className="mt-1 text-600">Computacion e informatica</div>
                            </div>
                        ...
                        <li className="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                            <div>
                                <span className="text-900 font-medium mr-2 mb-1 md:mb-0">Laptop HP Gamer</span>
                                <div className="mt-1 text-600">Computacion e informatica</div>
                            </div>
                        ...
                        <li className="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                            <div>
                                <span className="text-900 font-medium mr-2 mb-1 md:mb-0">Mouser Gamer</span>
                                <div className="mt-1 text-600">Computacion e informatica</div>
                            </div>
                            <div className="mt-2 md:mt-0 ml-0 md:ml-8 flex align-items-center">
                                <div className="surface-300 border-round overflow-hidden w-10rem lg:w-6rem" style={{ height: '8px' }}>
                        ...
                        <li className="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                            <div>
                                <span className="text-900 font-medium mr-2 mb-1 md:mb-0">Teclado Gamer</span>
                                <div className="mt-1 text-600">Computacion e informacion</div>
                            </div>
                            <div className="mt-2 md:mt-0 ml-0 md:ml-8 flex align-items-center">
                                <div className="surface-300 border-round overflow-hidden w-10rem lg:w-6rem" style={{ height: '8px' }}>
                        ...
                        <li className="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                            <div>
                                <span className="text-900 font-medium mr-2 mb-1 md:mb-0">Xataka Smart Home</span>
                                <div className="mt-1 text-600">Computacion e informatica</div>
                            </div>
                            <div className="mt-2 md:mt-0 ml-0 md:ml-8 flex align-items-center">
                                <div className="surface-300 border-round overflow-hidden w-10rem lg:w-6rem" style={{ height: '8px' }}>
            ...
            <Dialog visible={productDialog} style={{ width: '450px' }} header="Detalle de Venta" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                        {selectedProduct.image && <img src={`${contextPath}/demo/images/product/${selectedProduct.image}`} alt={selectedProduct.image} width="150" className="mt-0 mx-auto mb-5 block shadow-2" />}
                        <div className="field">
                            <label htmlFor="id">ID</label>
                            <InputText id="id" value={selectedProduct.id} onChange={(e) => onInputChange(e, 'id')} required autoFocus />
                        </div>
                        <div className="field">
                            <label htmlFor="code">Code</label>
                            <InputText id="code" value={selectedProduct.code} onChange={(e) => onInputChange(e, 'code')} required autoFocus />
                        </div>
                        <div className="field">
                            <label htmlFor="name">Nombre</label>
                            <InputText id="name" value={selectedProduct.name} onChange={(e) => onInputChange(e, 'name')} required autoFocus />
                        </div>
                        <div className="field">
                            <label htmlFor="category">Categoria</label>
                            <InputText id="category" value={selectedProduct.category} onChange={(e) => onInputChange(e, 'category')} required autoFocus />
                        </div>
                        <div className="field">
                            <label htmlFor="quantity">Cantidad</label>
                            <InputText id="quantity" value={selectedProduct.quantity} onChange={(e) => onInputChange(e, 'quantity')} required autoFocus />
                        </div>
                        <div className="field">
                            <label htmlFor="price">Precio</label>
                            <InputText id="price" value={selectedProduct.price} onChange={(e) => onInputChange(e, 'price')} required autoFocus />
                        </div>
                    </Dialog>
