            ...
            <div className="col-12">
                <div className="card">
                    ...
                    >
                        ...
                        <Column field="puesto" header="Puesto" sortable headerStyle={{ minWidth: '15rem' }}></Column>
                        <Column body={actionBodyTemplate} headerStyle={{ minWidth: '10rem' }}></Column>
                    </DataTable>

                    <Dialog visible={productDialog} style={{ width: '450px' }} header="Agregar Administrador" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                        <div className="field">
                            ...
                            {submitted && !product.nombre && <small className="p-invalid">Se requiere el nombre.</small>}
                        </div>
                        <div className="field">
                            ...
                            {submitted && !product.puesto && <small className="p-invalid">Se requiere el puesto.</small>}
                        </div>
                    </Dialog>
